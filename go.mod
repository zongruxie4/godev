...
require (
	...
	github.com/cdvelop/messagetype v0.0.27 // indirect
	github.com/cdvelop/tinystring v0.0.42 // indirect
	github.com/cdvelop/unixid v0.0.75 // indirect
...
require (
	...
	github.com/cdvelop/devtui v0.0.55
